...
namespace WebServer
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            if (context.Get<ApplicationDbContext>().Roles.Count() == 0)
            {
                ...
                //    UserName = "admin",
                //    Email = "admin",
                //    PasswordHash = userManager.PasswordHasher.HashPassword("@#Fbnf23f#@&GNsmfN@#*^Fsa"),
                //    SecurityStamp = Guid.NewGuid().ToString()
                //};
                //context.Get<ApplicationDbContext>().Users.Add(user);

                context.Get<ApplicationDbContext>().Roles.AddOrUpdate<IdentityRole>(new IdentityRole { Name = "admin" });
                context.Get<ApplicationDbContext>().Roles.AddOrUpdate<IdentityRole>(new IdentityRole { Name = "organizer" });
