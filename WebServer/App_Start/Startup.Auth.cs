...
namespace WebServer
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = ConfigurationManager.AppSettings["VkClientId"],
                ClientSecret = ConfigurationManager.AppSettings["VkClientSecret"],
                Scope = new List<string>()
                {

                },
                ApiVersion = ConfigurationManager.AppSettings["VkApiVersion"],
            });
        }
    }
}